...
class EnvParams:
    ...
    max_steps_in_ep: int = struct.field(False, default=300)
...
class LogisticMapCSCA(base_env.BaseEnvironment):
    ...
    def reward_and_done_function(self,
        ...
        done = jnp.logical_or(jnp.abs(state_tp1.x - params.fixed_point) < params.reward_ball, state_tp1.time >= params.max_steps_in_ep)
